 ...
 * `packages/ops`, and the only way to show a document without it was a second
 ...
 * mean what, and the two views read out of one tree. See services/sync/README.md,
 * "Applying the log".
 */
...
/**
 * Conventions, not protocol. services/sync/README.md is deliberately silent on what a
