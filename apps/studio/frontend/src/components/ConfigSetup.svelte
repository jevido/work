  ...
  <div class="card">
    {#if step === "folder"}
      ...
      {#if picked}
        ...
        <!-- Setup leaves a team behind, so say who they are and what to do
             with them: the next step is an editor or a mkdir, not another
             screen. The three starters are named as deletable on purpose --
             they are written once, into a folder that has never had agents in
             it, and a folder somebody removes stays removed. -->
        <p class="aside">
          You start with Anton, who routes work, and Jared, who thinks with you in
          Orientation and Isolation. Beside them are three colleagues to get going with —
          Chris on interfaces, Dennis on backends, Jeff on whole stacks — written for you to
          edit or delete. Add another by making a folder next to theirs, then Reload config
          from the wrench.
        </p>
      {:else}
        <p>
