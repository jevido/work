...
export class OfficeRenderer {
   ...
   * independently: a minimised window in implementation mode, and a visible window in
   * orientation mode. Folding them into one flag means whichever ends last turns the
