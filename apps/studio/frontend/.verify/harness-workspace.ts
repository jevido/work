...
try {
  localStorage.setItem(
    ...
    JSON.stringify({
      ...
      tabs: {
        "tab-b": {
          // Deliberately the old name. A snapshot written before the modes were
          // renamed has to come back as Orientation rather than being dropped,
          // and this fixture is the only place that is still true.
          mode: "idea",
          drafts: {},
          state: {
            "clock": 2,
