...
import (
	...
	"dev.jevido/work/apps/studio/internal/bridge"
	...
	"dev.jevido/work/apps/studio/internal/update"
...
func main() {
	...
	// with the app -- see bridge.WorkbenchService.ServiceStartup.
	...
	app := application.New(application.Options{
		...
		Services: []application.Service{
			application.NewService(bridge.NewWorkbenchService(wb)),
			application.NewService(bridge.NewUpdateService(updates)),
		},
