...
// The four modes, as the frontend names them. They are here because a
...
//
// mode is [ModeOrientation] or [ModeIsolation] and changes what is rendered, not how.
...
// outlineBody is the lines alone, so isolation mode can introduce them in its
