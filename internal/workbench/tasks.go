...
// source: the tasks somebody ordered the outline into, in planning. Those are
...
//     because that is the sentence somebody wrote in planning and a run that
...
//     task in planning closes the card here too.
//
...
func (w *Workbench) adoptTasks() {
	...
	for _, task := range tasks {
		...
		// New to this board: a task somebody wrote in planning, or one this
...
//
// This is the other outlet, and it is the one that makes work mode a source of
...
// next planning pass will see it.
//
