...
// The idea and planning half of the workspace document.
//
...
//
// The field names are conventions rather than protocol. server/README.md is
...
const (
	...
	// reads as TypeIdea: it is what every node written before the planning
...
// Task statuses. They are the planning view's three columns, which are not the
...
// ApplyEdits writes outline and planning edits into the workspace document.
//
